...
#SBATCH -o ./benchmarks/mv/large.o # output and error file name %j expands to jobID)
...
do
    ...
    do
        ...
        ./build/bin/matrix-vector_main ./benchmarks/mv/large_matrix43.mm ./benchmarks/mv/large_vector43.mm
    done
done
