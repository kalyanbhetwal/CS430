...
do
    ...
    echo "----------------------------------------------------"
    python3 generate_matrix.py -m1 ./benchmarks/mv/medium_matrix43.mm -m2 ./benchmarks/mv/medium_vector43.mm -o ./benchmarks/mv/medium_output43.mm -s $i -v
    for j in "${threads[@]}"
    do
        export OMP_NUM_THREADS=$j
        echo "Number of OMP Threads: $j"
        ./build/bin/matrix-vector_main ./benchmarks/mv/medium_matrix43.mm ./benchmarks/mv/medium_vector43.mm
    done
done
